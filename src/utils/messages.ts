 ...
 */
export const BETA_REGISTRY_MESSAGE = '💡 The OpenPackage remote registry is currently in private beta, please sign up for access at \x1b[4mhttps://openpackage.enulus.com\x1b[0m';

/**
 * API key signup message
 * Displayed when prompting users to obtain an API key
 */
export const API_KEY_SIGNUP_MESSAGE = '💡 Obtain an API key by signing up at \x1b[4mhttps://openpackage.enulus.com\x1b[0m';
